...
# Change paths if needed, these use the LGC/deps.git repository locations
...
contains(USE_UPNP, -) {
    ...
    DEFINES += USE_UPNP=$$USE_UPNP STATICLIB #DEFINES += USE_UPNP=$$USE_UPNP MINIUPNP_STATICLIB
...
contains(USE_LEVELDB, -) {
    ...
    !win32 {
        ...
        LIBS += -lshlwapi
        #genleveldb.commands = cd $$PWD/src/leveldb && CC=$$QMAKE_CC CXX=$$QMAKE_CXX TARGET_OS=OS_WINDOWS_CROSSCOMPILE $(MAKE) OPT=\"$$QMAKE_CXXFLAGS $$QMAKE_CXXFLAGS_RELEASE\" libleveldb.a libmemenv.a && $$QMAKE_RANLIB $$PWD/src/leveldb/libleveldb.a && $$QMAKE_RANLIB $$PWD/src/leveldb/libmemenv.a #PHS
    }
...
macx:ICON = src/qt/res/icons/LGC.icns
macx:TARGET = "LGC"
