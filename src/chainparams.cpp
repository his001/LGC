...
public:
    CMainParams() {
        ...
        //add 1 to the start message for LGC 1.0.1 so we dont talk to old wallets, and change the default port's
...
public:
    CTestNetParams() {
        ...
        nDefaultPort = 20000; // org 28888
        nRPCPort = 20009; // org 28889
        strDataDir = "testnet";
