...
enum RPCErrorCode
{
    ...
    //RPC_SERVER_NOT_STARTED          = -18, // RPC server was not started (StartRPCThreads() not called) 2017-09-19

    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Bitcoin is not connected
    RPC_CLIENT_IN_INITIAL_DOWNLOAD  = -10, // Still downloading initial blocks
    //RPC_CLIENT_NODE_ALREADY_ADDED   = -23, // Node is already added 2017-09-19
    //RPC_CLIENT_NODE_NOT_ADDED       = -24, // Node has not been added before 2017-09-19
...
extern json_spirit::Value getbestblockhash(const json_spirit::Array& params, bool fHelp); // in bitcoinrpc.cpp
