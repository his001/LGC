...
int64 nChainStartTime = 1522378800;
...
const string strMessageMagic = "LGC Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    if(nHeight == 1)
    {
        ...
        return nSubsidy + nFees + 5000000; // PHS premine
    }
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in LGC
    bool fStrictPayToScriptHash = true; // Always active in LGC
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "LGC", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        //const char* pszTimestamp = "2017-08-28 AirBitCoin with hope";
...
//        txNew.vout[0].scriptPubKey
        ...
        block.nVersion = 1;
        block.nTime    = 1522378800;  //2018-03-30
        ...
        assert(block.hashMerkleRoot == uint256("0x435b6019e519f9feb10933839e153c4d8f39474c751a149008fd37627562227b"));
        //assert(block.hashMerkleRoot == uint256("0x44391c652ddf4ae3a7954f2aac34dee34c0ab7c540c841061eb2f2bc7a23068c"));
