...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("LGC://"))
    {
        uri.replace(0, 12, "LGC:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "LGC.lnk";
}
...
{
    return GetAutostartDir() / "LGC.desktop";
}
