...
memory available when compiling LGCCoin Core. With 512MB of memory or less
...
If you want to build LGC-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a LGC-qt executable will be
built by default.
